...
The protocol for zero knowledge authentication which our implementation is based on was described by Lum Jia Jun.2  We briefly discuss it here in order to establish notation and correctness. 
